// JIP Reinforcement Options

// DECLARE VARIABLES AND FUNCTIONS
private ["_grp","_notAlone"];

// ALLOW PLAYER TO SELECT GROUP
// Using a dialog we allow the player to select the group s/he is going to
// [re-]join.
...
//
//  private _loadout = (player getVariable "f_var_JIP_loadout");
//  [_loadout,player] call f_fnc_assignGear;
//};

// REMOVE REINFORCEMENT OPTIONS ACTION TO PLAYER ACTION MENU
// We remove the action to the player's action menu.
// NB This is on the assumption that the player has made positive selections
// and not cancelled the menu.
...
// IMPLEMENT CHOICES
// Using the choices made by the player we implement the desired loadout and
// set the target group for her/him to join.
