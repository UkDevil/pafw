...
for [{_i=0}, {_i < _countWaypoints}, {_i=_i+1}] do {
    ...
    _waypointsEntry = [_wPos,_wHPos,_wBih,_wCM,_wCR,_wDes,_wForm,_wScr,_wShw,
                       _wSp,_wSt,_wTo,_wTy];
...
_fnc_spawnUnit = {
...

    {
        ...
        _unitWeapons = _x select 7;
        _unitItems = _x select 8;
        _unitUniform = _x select 9;
        _unitUniformItems = _x select 10;
        _unitVest = _x select 11;
        _unitVestItems = _x select 12;
        _unitBackpack = _x select 13;
        _unitBackpackItems = _x select 14;
        _unitHeadgear = _x select 15;
        _unitGoggles = _x select 16;
